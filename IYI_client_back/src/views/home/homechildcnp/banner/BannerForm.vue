<template>
  <div>
    ...
    <el-dialog title="轮播图管理" :visible.sync="dialogFormVisible" @close="cancelbanner">
      ...
      <el-form :model="currentItemInfo" @submit.native.prevent>
        ...
        <el-form-item label="轮播图预览" :label-width="formLabelWidth">
          <el-image style="width: 400px; height: 200px" :src="currentItemInfo.imgsrc" fit="cover"></el-image>
        </el-form-item>

        <el-form-item label="上传文件替换" :label-width="formLabelWidth">
